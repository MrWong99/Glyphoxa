...
func TestSeedThenLoadEquivalence(t *testing.T) {
	...
	conv, roster, cleanup, err := buildConversation(voiceevent.NewBus(), slog.New(slog.NewTextHandler(io.Discard, nil)), specs, "", ttseleven.New(""), nil, providerKeys{}, "", false, nil, nil, nil, nil, nil, tool.Deps{}, nil, nil)
	if err != nil {
...
func TestCampaignLanguageDrivesMatcherPhonetics(t *testing.T) {
	...
	conv, roster, cleanup, err := buildConversation(voiceevent.NewBus(),
		...
		ttseleven.New(""), nil, providerKeys{}, "", false, nil, nil, nil, nil, nil, tool.Deps{}, nil, nil)
	if err != nil {
...
func TestBuildConversation_CleanupDoesNotDestroyEngine(t *testing.T) {
	...
	conv1, _, cleanup1, err := buildConversation(voiceevent.NewBus(), log, npcs, "", ttseleven.New(""), nil, providerKeys{}, "", false, nil, nil, nil, nil, nil, tool.Deps{}, nil, nil)
	if err != nil {
	...
	conv2, _, cleanup2, err := buildConversation(voiceevent.NewBus(), log, npcs, "", ttseleven.New(""), nil, providerKeys{}, "", false, nil, nil, nil, nil, nil, tool.Deps{}, nil, nil)
	if err != nil {
...
func TestBuildConversation_ThreadsGMSpeakerIntoButlerGate(t *testing.T) {
	...
	_, _, cleanup, err := buildConversation(voiceevent.NewBus(), log, []npcSpec{hardcodedNPC()}, "",
		ttseleven.New(""), nil, providerKeys{}, "", false, nil, nil, nil, nil, gmSpeaker, tool.Deps{}, nil, nil)
	if err != nil {
