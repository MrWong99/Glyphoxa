...
// The default build links no libopus, so the default decoder is unavailable —
...
// own [DecoderFactory]. Build with `-tags opus -tags nolibopusfile` for the real
// decoder (decode_opus.go).
func init() {
