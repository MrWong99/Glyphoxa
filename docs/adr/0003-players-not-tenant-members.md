...
The Linked Player web-access lane is specified by ADR-0056 (2026-07-18): entry via Player Invitation, per-link Player Access Levels, GM-gated transcript/Highlight visibility.
